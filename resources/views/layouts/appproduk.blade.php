...
<head>
  ...
  <title>{{ config('app.name', 'Tokokids.com') }}</title>
  ...
  <link href="{{ asset('css/promobox.css') }}" rel="stylesheet">
     <!-- Scripts -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link waves-effect" href="https://mdbootstrap.com/material-design-for-bootstrap/" target="_blank">Tentang resto</a>
          </li>
