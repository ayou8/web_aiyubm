        ...
        <ul class="navbar-nav nav-flex-icons">
          <li class="nav-item">
            <a class="nav-link waves-effect">
              <span class="badge red z-depth-1 mr-1"> <?php echo Cart::count();?></span>
      ...
      <h2 class="my-5 h2 text-center"><u>Checkout form</u></h2>
        ...
        <div class="col-md-4 mb-4">
          ...
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            ...
            <span class="badge red badge-pill" ><?php echo Cart::count();?></span>
          </h4>
          ...
          <ul class="list-group mb-3 z-depth-1">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                ...
                <small class="text-muted">Price : @<?php echo $value->price;?> * <?php echo $value->qty;?></small>
              </div>
              <span class="text-muted"> <strong>Rp<?php echo number_format($value->price*$value->qty, 2, ',', '.');?></strong>
</span>
            </li>
          <?php }?>
