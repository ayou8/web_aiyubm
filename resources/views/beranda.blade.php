  ...
  <div class="card-body" >
   <div class="col-md-12">
      <h4>Keranjang Belanja</h4>
            ...
            <?php 
            echo "<b>Grand Total Rp".number_format(Cart::getTotal(), 2, ',', '.')."</b>";?>
...
<div id="carousel-1z" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://i.ytimg.com/vi/UgUByFJkam8/maxresdefault.jpg" alt="makanan">
    </div>
    <!--/First slide-->
    <!--Second slide-->
    <div class="carousel-item">
      <img class="d-block w-100" src="https://i.ytimg.com/vi/-7rL9RchKVk/maxresdefault.jpg" alt="minuman">
    </div>
    <!--/Second slide-->
    <!--Third slide-->
    <!--/Third slide-->
...
<!--/.Carousel Wrapper-->
      ...
      <h2><strong>Metode Pembayaran</strong></h2>
